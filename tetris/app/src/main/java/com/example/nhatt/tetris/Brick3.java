 ...
 */
public class Brick3 extends BrickParent{
    // lShape number 2
    public Brick3(){
      ...
      public void Rotation(TetrisView mother) {
        switch (StateOfRotation) {
          case 1: {
            int a = x2;
            int b = y2;
            if (maxX <= mother.col - 3 && !mother.listBool[a+1][b] &&  !mother.listBool[a-1][b] &&  !mother.listBool[a-1][b-1]) {//((bot < (mother.row - 2)) && minY > 0){
              x1 = x2 + 1;
              y1 = y2;
              x3 = x2 - 1;
              y3 = y2;
          ...
          case 2: {
            int a = x2;
            int b = y2;
            if (bot <= mother.row -3 && !mother.listBool[a][b+1] &&  !mother.listBool[a][b-1] &&  !mother.listBool[a+1][b-1]) {
          ...
          case 3: {
            int a = x2;
            int b = y2;
            if (minX > 1 && !mother.listBool[a-1][b] &&  !mother.listBool[a][b+1] &&  !mother.listBool[a+1][b+1]) {
              x1 = x2 - 1;
              y1 = y2;
              x3 = x2 + 1;
              y3 = y2;
