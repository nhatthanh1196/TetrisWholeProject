...
/**
 * Created by Admin on 24/5/2016.
 */
public class Brick7 extends BrickParent {
    //tShape
    public Brick7(){
  ...
  public void Rotation(TetrisView mother) {
    switch (StateOfRotation) {
      case 1: {
        int a=x2;
        int b= y2;
        if (bot <= mother.row - 2 && !mother.listBool[a+1][b] &&  !mother.listBool[a][b+1] &&  !mother.listBool[a][b-1]) {//((bot < (mother.row - 2)) && minY > 0){
          x1 = x2 + 1;
          y1 = y2;
          x3 = x2;
          y3 = y2 + 1;
      ...
      case 2: {
        int a= x2;
        int b= y2;
        if (minX > 1 && !mother.listBool[a][b+1] &&  !mother.listBool[a-1][b] &&  !mother.listBool[a+1][b]) {
      ...
      case 3: {
        int a=x2;
        int b=y2;
        if (minX > 1 && !mother.listBool[a-1][b] &&  !mother.listBool[a][b-1] &&  !mother.listBool[a][b+1]) {
          x1 = x2 - 1;
          y1 = y2;
          x3 = x2;
          y3 = y2 - 1;
      ...
      case 4: {
        int a=x2;
        int b=y2;
        if (maxX <= mother.col -2 && !mother.listBool[a][b-1] &&  !mother.listBool[a+1][b] &&  !mother.listBool[a-1][b]) {
          x1 = x2;
          y1 = y2 - 1;
          x3 = x2 + 1;
          y3 = y2;
  ...
  public void FindUnder(BrickParent bri){
    switch (bri.StateOfRotation){
      case 1:{
        ...
        bri.listBricksCompo[1].setUnder(true);
        break;
      }
      case 2: {
