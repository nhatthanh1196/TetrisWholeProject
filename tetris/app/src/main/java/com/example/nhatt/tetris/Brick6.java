...
public class Brick6 extends BrickParent{
    ...
    public void writeLog() // just for debug somes bugs.
    {
      if(x2 == 6 && y2 == 18)
      {
        Log.d("------> My Debug", "<-----------");
...
//      Log.d("-->x2-->", x1 + "," + y2);
      switch (StateOfRotation){
        case 1: {
            ...
            int b = y2;
          //writeLog();
          if ((bot < (mother.row - 2)) && minY > 0 && !mother.listBool[a][b-1] &&  !mother.listBool[a][b+1] &&  !mother.listBool[a][b+2]){
              x1 = x2;
              y1 = y2 - 1;
              x3 = x2;
              y3 = y2 + 1;
        ...
        case 2: {
          //writeLog();
            int a= x2;
            int b= y2;
          if (minX  >= 1 && maxX <= mother.col-3 && !mother.listBool[a-1][b] &&  !mother.listBool[a+1][b] &&  !mother.listBool[a+2][b]) {
            x1 = x2 - 1;
            y1 = y2;
            x3 = x2 + 1;
            y3 = y2;
